...
function createMainWindow() {
  ...
  mainWindow.on("closed", () => {
    if (externalPrompt !== null) externalPrompt.close();
...
ipcMain.on("asynchronous-message", (event, arg) => {
  ...
  if (arg === "network") {
    ...
    if (externalPrompt !== null) {
      console.log(arg);
      externalPrompt.webContents.send("asynchronous-reply", {
        option: "message",
        data: arg,
      });
    }
    ...
    },
    {
      ...
      submenu: [
        ...
        },
        {
          ...
          click() {
            require("electron").shell.openExternal("http://ckeditor.com/");
          },
        },
        { type: "separator" },
        {
